...
const folioItems = [
  { id: '01', title: 'Commercial & Product Still Life', aspect: 'md:col-span-7 aspect-[16/10]', img: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?auto=format&fit=crop&w=1200&q=80' },
  { id: '02', title: 'Spatial & Interior Architecture', aspect: 'md:col-span-5 aspect-[4/5]', img: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=800&q=80' },
  { id: '03', title: 'Culinary & Hospitality Arts', aspect: 'md:col-span-5 aspect-[4/5]', img: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=800&q=80' },
  { id: '04', title: 'Bespoke Executive Portraiture', aspect: 'md:col-span-7 aspect-[16/10]', img: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=1200&q=80' }
];
...
export default function Home() {
  ...
  return (
    <div dir={isRtl ? 'rtl' : 'ltr'} className="min-h-screen bg-[#0E0A07] text-[#F3E9DD] font-sans antialiased selection:bg-[#C97B4A] selection:text-black">
      ...
      {/* FOLIO GALLERY */}
      <section className="px-6 md:px-14 py-28 border-t border-[#C97B4A]/10 max-w-7xl mx-auto">
      ...
      {/* SERVICES */}
      <section className="px-6 md:px-14 py-28 border-t border-[#C97B4A]/10 bg-[#140E0A]">
          ...
          <div className="relative w-full max-w-lg bg-[#140E0A] border-s border-[#C97B4A]/25 h-full z-10 p-8 sm:p-12 overflow-y-auto flex flex-col justify-between shadow-2xl">
            <div>
              <div className="flex justify-between items-center mb-8 pb-4 border-b border-[#C97B4A]/15">
                ...
                <button onClick={() => setDrawerOpen(false)} className="text-xs uppercase text-[#A6907A] hover:text-white">✕</button>
              </div>
